...
// Constructor
Task::Task(int priority, TaskType type, string desc)
    : m_id(0), m_description(std::move(desc)), m_priority(priority), m_type(type)
...
Task::Task(int priority, string desc)
    : Task(priority, TaskType::General, std::move(desc)) {}
